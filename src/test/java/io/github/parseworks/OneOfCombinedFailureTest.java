...
public class OneOfCombinedFailureTest {
    ...
    public void oneOf_allAlternativesFail_combinesReasons() {
        ...
        Parser<Character, String> p1 = new Parser<>(inp -> new NoMatch<>(inp, "option A"));
        Parser<Character, String> p2 = new Parser<>(inp -> new NoMatch<>(inp, "option B"));
        Parser<Character, String> p3 = new Parser<>(inp -> new NoMatch<>(inp, "option C"));
