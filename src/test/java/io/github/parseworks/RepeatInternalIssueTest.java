...
public class RepeatInternalIssueTest {
    ...
    public void testRepeatInternalFailsWhenRepetitionFailsCritically() {
        ...
        Parser<Character, List<String>> manyAB = ab.oneOrMore();
        ...
        Result<Character, List<String>> res2 = manyAB.parse(Input.of("ABA"));
        ...
        Parser<Character, List<String>> manyABUntilExcl = simpleAB.oneOrMoreUntil(chr('!'));
        
        // Input "ABC" -> "AB" matches, then "C" is not "!" and not "AB".
        // It should fail because "!" was not reached.
        Result<Character, List<String>> res4 = manyABUntilExcl.parse(Input.of("ABC"));
